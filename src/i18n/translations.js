...
export const translations = {
  ...
  en: {
    ...
    catalog: {
      title: 'Full Color Catalog',
      subtitle: 'Browse every PPF & wrap film we offer',
      open: 'Browse Catalog',
      pdfBadge: 'PDF · all available colors',
      download: 'Download',
      newTab: 'New tab',
      share: 'Share',
      close: 'Close',
      heading: 'Color Catalog — GUARD FILM',
      fallback: "Can't see the catalog?",
    },
    gallery: {
    ...
    testimonials: {
      ...
      swipe: 'swipe',
      items: [
        "Guard Film wrapped my M3 in matte black PPF and the result is absolutely flawless. You can't even see the film edges. Worth every leu.",
        'Professional team, climate-controlled facility, and they took extra care with my AMG. The satin finish on the hood looks incredible.',
        "Finally a studio in Moldova that actually knows what they're doing. My Q7 looks factory-new and the paint is protected for years.",
        "I've had PPF done in Germany and Bucharest before. Guard Film is absolutely on the same level — detail-obsessed and professional.",
        'Full front-end PPF done perfectly. The film is invisible and the car feels new. Their catalog of films is huge — I loved choosing the finish.',
        'Brought my Range Rover for a full vinyl color change. The color shift film they recommended is stunning. People stop me on the street.',
      ],
    },
    contact: {
      label: 'Get in Touch',
  ...
  ro: {
    ...
    catalog: {
      title: 'Catalog Complet de Culori',
      subtitle: 'Răsfoiește toate foliile PPF și wrap disponibile',
      open: 'Răsfoiește Catalogul',
      pdfBadge: 'PDF · toate culorile disponibile',
      download: 'Descarcă',
      newTab: 'Filă nouă',
      share: 'Trimite',
      close: 'Închide',
      heading: 'Catalog de Culori — GUARD FILM',
      fallback: 'Nu se vede catalogul?',
    },
    gallery: {
      label: 'Transformări',
    ...
    testimonials: {
      label: 'Povești ale Clienților',
      title: 'CE SPUN CLIENȚII NOȘTRI.',
      swipe: 'glisează',
      items: [
        'Cei de la Guard Film mi-au aplicat folie PPF neagră mată pe M3 și rezultatul e absolut impecabil. Nici nu se văd marginile foliei. Merită fiecare leu.',
        'Echipă profesionistă, atelier cu climat controlat și au avut grijă deosebită de AMG-ul meu. Finisajul satinat de pe capotă arată incredibil.',
        'În sfârșit un studio din Moldova care chiar știe ce face. Q7-ul meu arată ca nou și vopseaua e protejată pentru ani buni.',
        'Am mai făcut PPF în Germania și București. Guard Film e exact la același nivel — obsedați de detalii și profesioniști.',
        'PPF complet pe partea din față, făcut perfect. Folia e invizibilă și mașina pare nouă. Au un catalog uriaș de folii — mi-a plăcut să aleg finisajul.',
        'Am adus Range Rover-ul pentru o schimbare completă de culoare cu vinil. Folia color shift recomandată de ei e superbă. Lumea mă oprește pe stradă.',
      ],
    },
    contact: {
      label: 'Ia Legătura',
  ...
  ru: {
    ...
    catalog: {
      title: 'Полный каталог цветов',
      subtitle: 'Все плёнки PPF и винил, которые мы предлагаем',
      open: 'Открыть каталог',
      pdfBadge: 'PDF · все доступные цвета',
      download: 'Скачать',
      newTab: 'Новая вкладка',
      share: 'Отправить',
      close: 'Закрыть',
      heading: 'Каталог цветов — GUARD FILM',
      fallback: 'Каталог не отображается?',
    },
    gallery: {
      label: 'Трансформации',
      titleLine1: 'РАЗНИЦА',
    ...
    testimonials: {
      ...
      swipe: 'листайте',
      items: [
        'Guard Film оклеили мой M3 чёрной матовой плёнкой PPF — результат идеальный. Краёв плёнки вообще не видно. Стоит каждого лея.',
        'Профессиональная команда, помещение с климат-контролем, к моему AMG отнеслись с особой заботой. Сатиновый капот выглядит невероятно.',
        'Наконец-то студия в Молдове, которая реально знает своё дело. Мой Q7 как новый, краска защищена на годы.',
        'Делал PPF в Германии и Бухаресте. Guard Film точно на том же уровне — внимание к деталям и профессионализм.',
        'Передняя часть полностью в PPF, сделано идеально. Плёнка невидима, авто как новое. Огромный каталог плёнок — было приятно выбирать.',
        'Пригнал Range Rover на полную смену цвета винилом. Плёнка-хамелеон, что они посоветовали, потрясающая. Люди останавливают на улице.',
      ],
    },
    contact: {
      label: 'Связаться',
